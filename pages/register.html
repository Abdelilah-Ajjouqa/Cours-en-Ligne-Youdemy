...
<body>
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-lg">
            ...
            <form method="post" action="../forms/register.php" class="mb-0 mt-6 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8">
                ...
                <div
                    ...
                    <label class="radio flex flex-grow items-center justify-center rounded-lg p-1 cursor-pointer">
                        ...
                        <span class="tracking-widest peer-checked:bg-gradient-to-r peer-checked:from-indigo-500 peer-checked:to-indigo-700 peer-checked:text-white text-gray-700 p-2 rounded-lg transition duration-150 ease-in-out">Student</span>
                    </label>

                    <label class="radio flex flex-grow items-center justify-center rounded-lg p-1 cursor-pointer">
                        <input type="radio" name="role" value="teacher" class="peer hidden" />
                        <span class="tracking-widest peer-checked:bg-gradient-to-r peer-checked:from-indigo-500 peer-checked:to-indigo-700 peer-checked:text-white text-gray-700 p-2 rounded-lg transition duration-150 ease-in-out">Teacher</span>
                    </label>
                </div>
